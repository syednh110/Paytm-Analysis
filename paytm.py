...
data=pd.read_csv('/home/namdar/Desktop/piro/paytm_fetch/Paytm.csv')
data=data.fillna(0)
...
df.to_csv('/home/namdar/Desktop/piro/paytm_fetch/Paytm_Debit.csv')
df1=data.groupby(data['Date'].dt.strftime('%B'))['Credit'].sum()
df1.to_csv('/home/namdar/Desktop/piro/paytm_fetch/Paytm_Credit.csv')
d['Date'] = pd.to_datetime(d['Date'])
df2=d.groupby(d['Date'].dt.strftime('%B'))['Credit'].sum()
df2.to_csv('/home/namdar/Desktop/piro/paytm_fetch/Paytm_Cashback.csv')
df3=df2.mean()
meandata=[df3]*12
debit_sum=df.sum()
